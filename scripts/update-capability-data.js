  ...
  try {
    ...
    for (const process of processes) {
      ...
      if (process.lowerSpecLimit && process.upperSpecLimit && process.sampleMean && process.sampleStdDev) {
        console.log(`⚠️  Process "${process.processName}" already has capability data. Updating with new values...`)
      }
      ...
      console.log(`   Mean: ${uniqueData.sampleMean.toFixed(2)}, StdDev: ${uniqueData.sampleStdDev.toFixed(3)}`)
    }
