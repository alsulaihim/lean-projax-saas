      ...
      <div key={`fishbone-${i}`} className={i === activeFishbone ? 'block' : 'hidden'}>
        ...
        <div className="grid grid-cols-3 gap-4 mb-4">
          {categoriesForThisStep.slice(0, 3).map(category => {
            ...
            return (
              <div key={category.id} className="border border-gray-300 rounded-lg p-4 bg-white shadow-sm">
                <h5 className="font-bold mb-3 text-sm text-gray-800 uppercase tracking-wider">
                  {categoryDisplayName}
                </h5>
