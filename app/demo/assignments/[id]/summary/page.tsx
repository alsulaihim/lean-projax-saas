...
export default async function DemoComprehensiveSummaryPage({
  ...
  // Fetch demo assignment with all related data
  ...
  return (
    <div className="max-w-[1800px] mx-auto py-4 md:py-6 px-3 md:px-4">
      ...
      <div className="mb-4 md:mb-6 flex flex-col md:flex-row md:items-center md:justify-between gap-3">
        ...
        <Button
          className="bg-gray-400 text-white cursor-not-allowed w-full md:w-auto"
          disabled
          title="PDF export is not available in demo mode"
        >
