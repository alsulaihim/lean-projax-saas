...
export default async function AssignmentsPage() {
  ...
  const canCreateAssignment =
    !userData?.isDemo && (user.role === UserRole.BPI_TEAM || user.role === UserRole.TEAM_LEAD)

  return (
    <div>
      <div className="mb-8">
        <h1 className="text-3xl font-bold mb-2">Assignments</h1>
        <p className="text-gray-600">Manage and track Six Sigma improvement assignments</p>
      </div>
